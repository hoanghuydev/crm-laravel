            ...
            <form method="POST" action="{{ route('products.update', $product) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="slug" name="slug" value="{{ old('slug', $product->slug) }}"
                           placeholder="URL-friendly version of the product name"
                    ...
                    <p class="mt-1 text-sm text-gray-500">URL-friendly version of the product name (leave empty to auto-generate)</p>
                    @error('slug')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
